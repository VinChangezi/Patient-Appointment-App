...
public class MyTestFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        MyTestFragment.MedicineAdapter adapter = new MyTestFragment.MedicineAdapter(); // Replace with your data
        recyclerView.setAdapter(adapter);

    }

    public class MedicineAdapter extends RecyclerView.Adapter<MyTestFragment.MedicineAdapter.ViewHolder> {
...
//        }
        ...
        @NonNull
        @Override
        public MyTestFragment.MedicineAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.singel_test_list, parent, false);
            return new MyTestFragment.MedicineAdapter.ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull MyTestFragment.MedicineAdapter.ViewHolder holder, int position) {
